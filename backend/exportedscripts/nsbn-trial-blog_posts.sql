...
CREATE TABLE `posts` (
  ...
  PRIMARY KEY (`postid`),
  KEY `user_idx` (`userposted`),
  CONSTRAINT `userlink` FOREIGN KEY (`userposted`) REFERENCES `users` (`publicusername`) ON DELETE NO ACTION ON UPDATE NO ACTION
